...
{
	public interface IEventProviderCS_applicationsrecieved
	{
		//	handlers
	...
	public interface IEventProviderVB_applicationsrecieved
	{
		//	handlers
	...
	public class eventclass_applicationsrecieved : EventsAggregatorBase
	{
		//[Import(typeof(IEventProviderCS_applicationsrecieved))]
		public IEventProviderCS_applicationsrecieved EventProviderCS;

		//[Import(typeof(IEventProviderVB_applicationsrecieved))]
		public IEventProviderVB_applicationsrecieved EventProviderVB;

		public void CreateEvents()
        {
			EventProviderCS = new eventclassCS_applicationsrecieved();
			if(appsettings.vbEvents != null)
			{
				Type eType = appsettings.vbEvents.GetType("runnerDotNet.runnerDotNet.eventclassVB_applicationsrecieved");
				if(eType != null)
				{
					EventProviderVB = (IEventProviderVB_applicationsrecieved)Activator.CreateInstance(eType);
				}
			}
        }

		public eventclass_applicationsrecieved()
		{
			CreateEvents();
