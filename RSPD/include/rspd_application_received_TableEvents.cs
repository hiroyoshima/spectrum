...
{
	[Export(typeof(IEventProviderCS_rspd_application_received))]
	public class eventclassCS_rspd_application_received : IEventProviderCS_rspd_application_received
	{
