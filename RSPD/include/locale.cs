...
namespace runnerDotNet
{
	public partial class CommonFunctions
	{
		public static void InitLocale()
		{
			...
			GlobalVars.locale_info["LOCALE_CTRYNAME"] = "PH";
			// date settings
			GlobalVars.locale_info["LOCALE_ICENTURY"] = "1";
			GlobalVars.locale_info["LOCALE_IDATE"] = "1";
			GlobalVars.locale_info["LOCALE_ILDATE"] = "1";
			GlobalVars.locale_info["LOCALE_SDATE"] = "/";
			GlobalVars.locale_info["LOCALE_SLONGDATE"] = "dddd, d MMMM yyyy";
			GlobalVars.locale_info["LOCALE_SSHORTDATE"] = "dd/MM/yyyy";
			// weekday names
